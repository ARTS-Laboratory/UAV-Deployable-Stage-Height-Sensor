...
USGS = pd.read_csv('USGS_v3_fieldtest_jan15.csv', header=0, parse_dates=[0,1], index_col=1, squeeze=True)
print(type(USGS))
print(USGS.head())

ARTS = pd.read_csv('ARTS_v3_fieldtest_jan15.csv', header=0, parse_dates=[0,1], index_col=1, squeeze=True)
print(type(ARTS))
print(ARTS.head())
