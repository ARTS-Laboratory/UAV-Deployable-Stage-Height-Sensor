...
# df1 = pd.read_csv('sumter_july2.csv',parse_dates=     {"Datetime" : [0,1]})
df2 = pd.read_csv('maxcy_july2.csv',parse_dates=     {"Datetime" : [0,1]})
df3 = pd.read_csv('USGS_july2_maxcy.csv',parse_dates=     {"Datetime" : [0,1]})
